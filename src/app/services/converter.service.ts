...
export class ConverterService {
  ...
  private apiUrl: string = 'https://openexchangerates.org/api/latest.json';
  private appId: string = '18392e1059f8498594bec31628fd3e31';
  ...
  exchangeRates$: Observable<ExchangeRates> = this.exchangeRates$$.asObservable()
    .pipe(
      filter((exchangeRates: ExchangeRates) => !!exchangeRates)
    );
